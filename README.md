...
And **when you're finished**, you can check your results against the the code in `gs-actuator-service/complete`.
...
compile "org.springframework.bootstrap:spring-bootstrap-actuator:0.5.0.BUILD-SNAPSHOT"
```
